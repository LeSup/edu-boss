    ...
    <el-form label-width="80px">
      <div v-show="activeStep === 0">
        ...
        <el-form-item label="课程概述">
          <el-input
            ...
            placeholder="概述1"
          />
          <el-input v-model="course.previewSecondField" type="textarea" placeholder="概述2"/>
        </el-form-item>
      ...
      <div v-show="activeStep === 1">
        <el-form-item label="课程封面">
          <course-image :limit="5" v-model="course.courseListImg"/>
        </el-form-item>
...
export default Vue.extend({
  ...
  data () {
    return {
      ...
      steps: [
        ...
        { title: '销售信息', icon: 'el-icon-s-goods' },
        { title: '秒杀活动', icon: 'el-icon-s-marketing' },
        { title: '课程详情', icon: 'el-icon-s-claim' }
      ],
      course: {
        courseName: '',
        brief: '',
  ...
  methods: {
    async loadCourse () {
      ...
      const { activityCourse, activityCourseDTO } = data.data
      if (activityCourse) {
